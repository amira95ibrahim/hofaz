        ...
        <section>
            <div class="container pt-70 pb-40">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-12">
                            <h2>{{ $projectsPageDetails->title }}</h2>
                            <p>{{ $projectsPageDetails->details }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="wrapper">
                            <form class="form-group" action="{{ route('projects') }}" method="get" id="filterForm">
                                <div class="filter-tab">
                                    <div class="country-gender">
                                        <select class="form-control filterProjects" name="country">
                                            <option selected="" value="">@lang('kafala.select_country')</option>
                                            @foreach($projectsCountries as $country)
                                    ...
                                    <div class="flip-card-front{{ $key }}">
                                        <div class="causes bg-white maxwidth500 mb-30">
                                            ...
                                            <div class="causes-details border-1px bg-white clearfix p-20 pt-10 pb-20">
                                                <h4 class="font-20 text-uppercase"><a href="{{ route('project.show', $project->id) }}" >{{ $project->name }}</a></h4>
