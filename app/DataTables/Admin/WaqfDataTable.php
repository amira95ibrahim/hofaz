...
class WaqfDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.waqf.datatables_actions')
     ...
     *
     * @param \App\Models\Waqf $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Waqf $model)
    {
