...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">تعديل: {{ $publication->name }}</li>
    </ol>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        {!! Form::model($publication, ['route' => ['admin.publications.update', $publication->id], 'method' => 'patch', 'enctype' => 'multipart/form-data']) !!}
