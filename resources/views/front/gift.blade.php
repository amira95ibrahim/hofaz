                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body text-center">
                                            <h4>{{ $gift->giftable->name }}</h4>
                                                <input type="text" name="donate" class="form-control br-20" value="{{ $gift->giftable->initial_amount }}">
{{--                                                <input type="text" name="donate" class="form-control br-20" value="10">--}}
                                                ...
                                                <button type="button" style="display: none"
                                                        class="btn btn-dark mt-1 btn-xl btn-theme-colored btn-flat mr-5" disabled><i class="fa fa-check"></i></button>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
