...
class PublicationDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.publications.datatables_actions')
            ...
            ->editColumn('image', function ($q){
                return '<img src="' . asset($q->image) . '" width="200px" height="200px" />';
            })
            ->editColumn('pdf', function ($q){
                return '<embed src="' . asset($q->pdf) . '" width="500px" height="200px" />';
            })
            ->rawColumns(['action', 'homepage', 'active', 'image', 'pdf']);
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            'pdf' => new Column(['title' => 'البورشور', 'data' => 'pdf']),
    ...
    {
        return 'publications_datatable_' . time();
    }
}
