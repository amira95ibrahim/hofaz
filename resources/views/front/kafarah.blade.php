            ...
            <div class="container">
                <div class="row">
                    <div class="p-30 bg-grey br-20 clearfix">
                        <div class="col-md-6">
                            <form action="{{route('donation')}}" method="GET">
                                <select class="form-control mb-15 br-20 product_data">
                                    @foreach($Kafarah as $kafarah)
                                        <option value="{{ $kafarah->id }}" id="name_{{ $kafarah->id }}">{{ $kafarah->name }}</option>
                                    @endforeach
                                ...
                                <div class="btn-group mr-140" role="group" aria-label="Basic example">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset($kafarahPage->image) }}" alt="">
                        </div>
                        <div class="col-md-12">
                            <h4 style="border-bottom: 1px solid orange;background: antiquewhite;padding: 8px; margin-bottom: 0;">{{ $kafarahPage->title }}</h4>
                            <p style="margin-top: 15px;font-size: 16px;">{{ $kafarahPage->details }}</p>
