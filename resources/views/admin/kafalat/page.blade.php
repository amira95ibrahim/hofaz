...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">تعديل وصف الكفالة </li>
    </ol>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        {!! Form::model($kafalahDetails, ['route' => ['admin.kafalahPage.update', $kafalahDetails->id], 'method' => 'patch', 'enctype' => 'multipart/form-data']) !!}
