...
class KafalaTypeDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.kafala_types.datatables_actions')
     ...
     *
     * @param \App\Models\KafalaType $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(KafalaType $model)
    {
    ...
    {
        return 'kafala_types_datatable_' . time();
    }
}
