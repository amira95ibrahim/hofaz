...
@section('content')
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            ...
            <!-- BEGIN HEADER MENU -->
            <div class="page-header-menu" style="background: #42454C !important;">
                <div class="container">
                    ...
                    <div class="hor-menu ">
                        <ul class="nav navbar-nav">
                            <li class="active">
                                <a href="../Pages/SDefault.aspx" class="pplighter" style="font-size: 15px">الرئيسية</a>
                            </li>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <ul class="mega-menu-submenu">
                                                        <li>
                                                            <h3 class="pp">تبرعاتي</h3>
                                                        </li>
                                                        <li>
                                                            <a href="../Pages/MyDonation.aspx" class="iconify ">
                                                                <i class="icon-basket"></i><span class="FontEltany" style="font-size: 12px">تبرعاتي</span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="../Pages/MySummery.aspx" class="iconify ">
                                                                <i class="icon-home"></i>
                                                                <span class="FontEltany" style="font-size: 12px"> مسيرة الخير</span>   </a>
                                                        </li>
                            ...
                            <li class="menu-dropdown">
                                <a href="../Pages/MyProjects.aspx" class="tooltips" data-container="body" data-placement="bottom" data-html="true"><span class="pplighter">مشروعاتي</span>
                                </a>

                            </li>
                            <li class="menu-dropdown">
                                <a href="../Pages/MyOrphansList.aspx" class="tooltips" data-container="body" data-placement="bottom" data-html="true"><span class="pplighter">كفالاتي</span>
                                </a>

                            </li>
                            <li class="menu-dropdown">
                                <a href="../Pages/Reports.aspx" class="tooltips" data-container="body" data-placement="bottom" data-html="true"><span class="pplighter">تقاريري</span>
                                </a>

                            </li>

                            <li class="menu-dropdown">
                                <a href="../Pages/FAQ.aspx" class="tooltips" data-container="body" data-placement="bottom" data-html="true" ><span class="pplighter" style="font-size: 16px">أسئلة شائعة</span> </a>
                            </li>
                            <li class="menu-dropdown classic-menu-dropdown ">
                                ...
                                <ul class="dropdown-menu pull-left">
                                    ...
                                    <li>
                                        <a href="../Pages/MyIncidentList.aspx" style="font-family: 'Segoe UI' !important; font-size: 12px;">قائمة الشكاوي
                                        </a></li>

                                </ul>
                            </li>
                             <li class="menu-dropdown">
                                <a href="../Pages/UpdateInfo.aspx" class="tooltips" data-container="body" data-placement="bottom" data-html="true" ><span class="pplighter">تعديل بياناتي </span> </a>
                            </li>

                            <li style="display:none;">
                                <a href="../../default.aspx" class="tooltips" data-container="body" data-placement="bottom" data-html="true" ><span class="pplighter">موقع الرحمة </span> </a>
                            </li>
                            ...
                            <div class="row" style="text-align: left">
                              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" >
                                ...
                                <div class="small-box bg_inffo">
                                  ...
                                  <a href="#" class="small-box-footer"><span id="ctl00_ContentPlaceHolder1_lblOrfCount">0</span><span class="pp"> مكفول / مساهمات كفالات </span>  <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                              </div>
                              <!-- ./col -->
                              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" >
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" >
                                ...
                                <div class="small-box bg_move">
                                  ...
                                  <a href="#" class="small-box-footer"><span id="ctl00_ContentPlaceHolder1_lblWaqCount">0</span>
                              ...
                              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" >
                                ...
                                <div class="small-box bg_orange">
                                  ...
                                  <a href="#" class="small-box-footer"><span id="ctl00_ContentPlaceHolder1_lblOrfCount">0</span><span class="pp"> مشروع </span>  <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                              </div>
                              <!-- ./col -->
                            </div>
