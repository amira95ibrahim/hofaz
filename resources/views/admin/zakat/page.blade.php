...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">تعديل وصف الزكاة </li>
    </ol>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        {!! Form::model($zakahDetails, ['route' => ['admin.zakahPage.update', $zakahDetails->id], 'method' => 'patch', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    @include('admin.components.imageInput', ['image' => asset($zakahDetails->image)])
                                </div>
