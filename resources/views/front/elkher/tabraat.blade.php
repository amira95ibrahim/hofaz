...
<div class="page-content">
    <div class="container" style="margin-bottom: 10rem">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li class="active"><span class="pp" style="font-size: 16px;">سجل التبرعات </span>
            </li>
...
<div id="dvPortlet " class="portlet box" style="background-color: rgb(227, 91, 90); border: 1px solid rgb(227, 91, 90); position: static; zoom: 1; padding:0 30px ; ">
    ...
    <div class="col row btn-group" data-toggle="buttons" style="margin: 7px 10px;">
        <label id="btnShowBeneficiary" class="btn btn-default  pp2 btnSort" style="width: 150px; font-size: 15px;">
            ...
            <i class="fa fa-user" style="color: #000; margin-left: 10px; font-size: 15px; color: #008aff;"></i>
            المستفيد
        </label>
        <label id="btnShowPayMthod" class="btn btn-default  pp2 btnSort" style="width: 150px; font-size: 15px;">
            <input class="toggle" type="radio">
            <i class="fa fa-credit-card" style="color: #000; margin-left: 10px; font-size: 15px; color: #008aff;"></i>
            طريقة الدفع
        </label>
...
<div style="border: red solid  2px ; padding:20px">
  <span></span>
</div>
