...
<div class="page-content">
    <div class="container" style="margin-bottom: 10rem">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li class="active"><span class="pp" style="font-size: 16px;">وقفياتى</span>
            </li>
...
<div id="dvPortlet " class="portlet box" style="background-color: #8775a7; border: 1px solid #8775a7; position: static; zoom: 1; padding:0 30px ; ">
    ...
    <div class="col row btn-group" data-toggle="buttons" style="margin: 7px 10px;">
        <label id="btnShowBeneficiary" class="btn btn-default  pp2 btnSort" style="width: 150px; font-size: 15px;">
            ...
            <i class="fa fa-star" style="color: #000; margin-left: 10px; font-size: 15px; color: rgb(227, 91, 90);"></i>
            حالة الوقفيه
        </label>
        <label id="btnShowCountry" class="btn btn-default  pp2 btnSort" style="width: 150px; font-size: 15px;">
            <input class="toggle" type="radio">
            <i class="fa fa-building" style="color: #000; margin-left: 10px; font-size: 15px; color:rgb(227, 91, 90);"></i>
            نوع الوقفيه
        </label>
...
<div style="border:#8775a7 solid  2px ; padding:20px">
  <span></span>
</div>
