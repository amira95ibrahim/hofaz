...
class SadaqahDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.sadaqat.datatables_actions')
     ...
     *
     * @param \App\Models\Sadaqah $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Sadaqah $model)
    {
    ...
    {
        return 'sadaqahs_datatable_' . time();
    }
}
