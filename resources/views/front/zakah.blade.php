                            ...
                            <form action="{{route('PeriodicDonation')}}" method="POST">
                                ...
                                <div class="btn-group mr-40" role="group" aria-label="Basic example">
                                    ...
                                    <button type="submit" class="btn custom-btn-success mr-5"><i
                                                class="ri-bank-card-line btn-icon"></i> @lang('zakah.deduction')
                                    </button>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6">
                            <img src="{{ asset($zakahPage->image) }}" alt="">
                        </div>
                        <div class="col-md-12">
                            <h4 style="border-bottom: 1px solid orange;background: antiquewhite;padding: 8px; margin-bottom: 0;">{{ $zakahPage->title }}</h4>
                            <p style="margin-top: 15px;font-size: 16px;">{{ $zakahPage->details }}</p>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            selectZakah($('.product_data').val());
            $('.product_data').on('change', function () {
                selectZakah($(this).val());
            });
