            ...
            <div class="container">
                <div class="row">
                    <div class="p-30 bg-grey br-20 clearfix">
                        <div class="col-md-6">
                            <h2> {{ $project->name }} - <span class="text-theme-colored"> {{ $project->country->name }}
                                </span></h2>
                                        ...
                                        @if ($project->show_remaining)
                                            <ul class="list-inline font-weight-600 font-16 clearfix mt-15">
                                                <li class="pull-left font-weight-400 text-black-333 pr-0">@lang('relief.raised')
                                                    :
                                                    <span
                                                        class="text-theme-colored font-weight-700">{{ number_format($project->cost - $project->paid) }}
                                                        @lang('relief.KWD')</span>
                                                </li>
                                                <li class="pull-right font-weight-400 text-black-333 pr-0">@lang('relief.goal')
                                                    :
                                                    <span
                                                        class="text-theme-colored font-weight-700">{{ number_format($project->cost) }}
                                                        @lang('relief.KWD')</span>
                                                </li>
                                            </ul>
                                            <div class="progress-item mt-15">
                                                <div class="progress mb-0">
                                                    <div data-percent="{{ round(($project->paid * 100) / $project->cost) }}"
                                                        class="progress-bar"><span class="percent">0</span></div>
                                                </div>
                                            </div>
                                        @else
                                            <div
                                                class="progress-item text-center font-weight-700 text-black-333 mt-30 mb-30 share_price">
                                                @lang('relief.share_price') :
                                                <span class="text-theme-colored font-weight-700">{{ $project->cost }}
                                                    @lang('relief.KWD')</span>
                                            </div>
                                        @endif
                                    </div>
                            ...
                            <div class="donation-amount">
                                ...
                                <div class="slect-amount">
                                    <div class="button">
                                        ...
                                        <label class="btn btn-default" for="a25">{{ $project->initial_amount }}
                                            @lang('waqf.KWD')</label>
                                    </div>
                                    <div class="button">
                                        ...
                                        <label class="btn btn-default"
                                            for="a50">{{ $project->show_remaining ? $project->initial_amount + 10 : $project->initial_amount * 2 }}
                                            @lang('waqf.KWD')</label>
                                    </div>
                                    <div class="button">
                                        ...
                                        <label class="btn btn-default"
                                            for="a75">{{ $project->show_remaining ? $project->initial_amount + 20 : $project->initial_amount * 3 }}
                                            @lang('waqf.KWD')</label>
                                    </div>
                                    <div class="button">
                                        <input type="radio" id="a75" name="check-substitution-2"
                                        ...
                                        <label class="btn btn-default"
                                            for="a75">{{ $project->show_remaining ? $project->initial_amount + 30 : $project->initial_amount * 4 }}
                                            @lang('waqf.KWD')</label>
                                    </div>
                                </div>
                                ...
                                <form class="mt-1">hi
                                    <div class="input-group">
                                        ...
                                        <input type="hidden"
                                            ...
                                            value="{{ $project->image }}">
                                        <input type="hidden" id="{{ 'product_' . $model . '_' . $project->id . '_name' }}"
                                            value="{{ $project->name }}">
                                        <span class="input-group-btn">
                                            <button data-height="45px"
                                                class="btn btn-colored btn-theme-colored btn-xs m-0 font-14" type="button"
                                                style="height: 45px;">
                                                @lang('relief.KWD')
                                            </button>
                                        </span>
                        ...
                        <div class="col-md-6">
                            <h4
                                style="border-bottom: 1px solid orange;background: antiquewhite;padding: 8px; margin-bottom: 0;">
                                @lang('projects.project_description')</h4>
