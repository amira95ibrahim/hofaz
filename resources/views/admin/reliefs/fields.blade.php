            ...
            <div class="card-block collapse in" id="collapseExample">
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        {!! Form::label('name_ar', 'اسم الاغاثة:') !!}
                    ...
                    <div class="form-group col-sm-12">
                        {!! Form::label('description_ar', 'تفاصيل الاغاثة:') !!}
            ...
            <div class="card-block collapse in" id="collapseExample3">
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        @include('admin.components.imageInput', ['image' => (isset($relief)) ? asset($relief->image) : null])
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-block collapse in" id="collapseExample2">
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        @include('admin.countries.activeList', ['selectedCountry' => (isset($relief)) ? $relief->country_id : null, 'disable_multiselect' => (isset($relief))])
                    </div>
